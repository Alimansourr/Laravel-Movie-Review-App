...
<body class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
    ...
    <main class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="mt-12 text-center">
            <button class="bg-white/5 backdrop-blur-xl border border-white/20 text-white font-semibold px-8 py-3.5 rounded-xl hover:bg-white/10 transition duration-200">
                Load More Movies
            </button>
        </div>
    </main>
