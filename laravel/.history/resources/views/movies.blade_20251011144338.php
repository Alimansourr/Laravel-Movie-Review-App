            ...
            <div class="flex items-center justify-between">
                ...
                <nav class="flex items-center space-x-6">
                    <a href="{{ route('user.bookings') }}"
                        class="text-gray-300 hover:text-white transition duration-200">My Bookings</a>

                   <a href="{{ route('user.profile') }}" class="text-gray-300 hover:text-white transition duration-200">Profile</a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($movies as $mov)
                    <a href="/searching/{{$mov->id}}" class="group">
                        <div
                            class="bg-white/5 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/10 hover:border-purple-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 hover:-translate-y-2">
                            <!-- Movie Poster -->
                            <div class="relative aspect-[2/3] overflow-hidden bg-slate-800">
                                <img src="/assets/{{$mov->thumbnail}}" alt="{{$mov->title}}"
                                    class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
                                <div
                                    class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-300">
                                </div>
                                ...
                                <div
                                    ...
                                    <div
                                        class="w-16 h-16 bg-purple-500 rounded-full flex items-center justify-center shadow-2xl transform scale-75 group-hover:scale-100 transition duration-300">
                            ...
                            <div class="p-5">
                                <h3
                                    class="text-white font-bold text-lg mb-2 group-hover:text-purple-400 transition duration-200 line-clamp-1">
                                    {{$mov->title}}
                                </h3>
                                ...
                                <div class="flex items-center justify-between pt-4 border-t border-white/10">
                                    <button
                                        class="flex items-center space-x-2 text-gray-400 hover:text-purple-400 transition duration-200">
                                    ...
                                    <button
                                        class="bg-gradient-to-r from-purple-500 to-pink-500 text-white text-sm font-semibold px-5 py-2 rounded-lg hover:from-purple-600 hover:to-pink-600 transition duration-200 shadow-lg shadow-purple-500/30">
                                        Book Now
                                    </button>
                                </div>
                            </div>
