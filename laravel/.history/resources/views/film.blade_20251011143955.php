...
<body class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div
            class="absolute top-20 left-10 w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse">
        </div>
        <div
            class="absolute bottom-20 right-10 w-96 h-96 bg-pink-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse delay-1000">
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    <div
                        class="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl flex items-center justify-center shadow-lg shadow-purple-500/50">
                ...
                <button onclick="redirectTomovies()"
                    class="flex items-center space-x-2 text-gray-300 hover:text-white transition duration-200 group">
                    <svg class="w-5 h-5 group-hover:-translate-x-1 transition duration-200" fill="none"
    ...
    <main class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="grid md:grid-cols-5 gap-8 p-8">
                ...
                <div class="md:col-span-2">
                    <div class="relative group">
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-purple-500/20 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition duration-300">
                        </div>
                        <img src="/assets/{{$movie->thumbnail}}" alt="{{$movie->title}} Poster"
                    ...
                    <div class="mt-6 space-y-3">
                        <a href="{{ route('movie.cinemas', $movie->id) }}"
                            class="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold py-4 rounded-xl hover:from-purple-600 hover:to-pink-600 transition duration-200 shadow-lg shadow-purple-500/50 flex items-center justify-center space-x-2">
                ...
                <div class="md:col-span-3">
                    <div class="flex items-center space-x-1">
                        @for ($i = 1; $i <= 5; $i++)
                            ...
                            @elseif($avgRating > ($i - 1) && $avgRating < $i)
                                <svg class="w-5 h-5 text-yellow-400 opacity-70" fill="currentColor" viewBox="0 0 20 20">
                                    <path
                                        d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                </svg>
                            @else
                        ...
                        @endfor
                        <span
                            class="ml-2 text-yellow-400 font-semibold">{{ $avgRating ? number_format($avgRating, 1) : 'N/A' }}</span>
                    </div>
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-white mb-4 flex items-center">
                            <div class="w-1 h-8 bg-gradient-to-b from-purple-500 to-pink-500 rounded-full mr-3">
                            </div>
                            Synopsis
                        </h2>
        ...
        <div class="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/20 p-8 shadow-2xl">
            <div class="flex items-center justify-between mb-8">
             ...
             <button onclick="redirectToReview({{ $movie->id }})"
    class="bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold px-6 py-3 rounded-xl hover:from-purple-600 hover:to-pink-600 transition duration-200 shadow-lg shadow-purple-500/50 flex items-center space-x-2">
            ...
            @if(count($reviews) > 0)
                <div class="space-y-6">
                    @foreach ($reviews as $rev)
                        <div
                            class="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10 hover:border-purple-500/30 transition duration-300">
